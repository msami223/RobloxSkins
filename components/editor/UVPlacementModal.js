      ...
      <div style={modalStyle}>
        ...
        <div style={headerStyle}>
          <h2 style={{ margin: 0, fontSize: '18px', fontWeight: 600 }}>
            Place Image on {uvPlacementMode === 'shirt' ? 'Shirt' : 'Pants'} UV Map
          </h2>
        ...
        <p style={instructionStyle}>
          Drag, scale, and rotate your image. The wireframe shows UV regions that map to the 3D model.
        </p>
        ...
        <p style={helpTextStyle}>
          <i className="fa-solid fa-lightbulb"></i> Tip: Use corner handles to resize, rotate handle to rotate
        </p>
